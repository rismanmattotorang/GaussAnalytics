...
| JDBC data-source drivers | Connect to warehouses | `gauss-drivers` (`Driver` trait: SQLite/Postgres/MySQL via `sqlx`; BigQuery/Snowflake/ClickHouse via REST) | `sqlx`, `reqwest` | 2→4 | ◐ |
